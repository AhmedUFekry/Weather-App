package com.example.weatherapp.UILayer.SettingScreen.View
...
class settingsFragment : Fragment() {
    ...
    private fun saveSettingsData() {
        ...
        LanguageUtils.setAppLocale(SettingsConstants.getLangCode(), requireContext())
        LanguageUtils.setAppLayoutDirections(SettingsConstants.getLangCode(), requireContext())
        LanguageUtils.changeLang(requireActivity(), SettingsConstants.getLangCode())
    ...
    private fun initSettingsUi() {
        ...
        if(SettingsConstants.getLangCode()=="en") {
